...
public final class YourStageSkyboxLocale {
    ...
    private static String getCurrentLanguage() {
        try {
            ...
            Object mc = cls.getMethod("getInstance").invoke(null);
            Object langObj = cls.getMethod("getLanguageManager").invoke(mc);
            Object current = langObj.getClass().getMethod("getSelected").invoke(langObj);
            return (String) current.getClass().getMethod("getCode").invoke(current);
