...
/**
 * 天空盒渲染器 —— 1.20.1 版本，通过 DimensionSpecialEffects 原生钩子实现。
 */
@OnlyIn(Dist.CLIENT)
public class SkyboxRenderer {
    ...
    public static void onRegisterDimensionEffects(RegisterDimensionSpecialEffectsEvent event) {
        event.register(new ResourceLocation("overworld"), new SkyboxEffects(DimensionSpecialEffects.SkyType.NORMAL, true));
        event.register(new ResourceLocation("the_nether"), new SkyboxEffects(DimensionSpecialEffects.SkyType.NONE, false));
        event.register(new ResourceLocation("the_end"), new SkyboxEffects(DimensionSpecialEffects.SkyType.END, false));
    }
